defmodule ArayaGist.GistsTest do
  use ArayaGist.DataCase

  alias ArayaGist.Gists

  describe "gists" do
    alias ArayaGist.Gists.Gist

    import ArayaGist.GistsFixtures
  ...
  describe "saved_gists" do
    alias ArayaGist.Gists.SavedGist
